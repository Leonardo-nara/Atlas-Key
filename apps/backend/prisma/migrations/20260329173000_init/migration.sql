...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('STORE_ADMIN', 'COURIER');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'ACCEPTED', 'ASSIGNED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED');
...
-- CreateIndex
CREATE UNIQUE INDEX "stores_ownerUserId_key" ON "stores"("ownerUserId");
